...
def new_game(word) do
  ...
  def score_guess(game, _score_guess = true) do
  ...
  def score_guess(game, _not_score_guess) do
    game
  end
  ...
  def maybe_won(_does_match = true), do: :won
  def maybe_won(_doesnt_match), do: :good_guess
